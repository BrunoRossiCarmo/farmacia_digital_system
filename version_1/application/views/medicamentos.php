            ...
            echo '<table class="table">'; 
                ...
                foreach ($users as $user) {
                    echo '<tr>';
                        ...
                        echo '<td>'.$user->princ_ativo.'</td>';
                        echo '<td>'.$user->quantidade.'</td>';
                        echo '<td>'.$user->valor.'</td>';
                        echo '<td>';
                            echo '
                                <a href="#" data-bs-toggle="modal" data-bs-target="#visualizar_modal" data-bs-nome="'.$user->nome.'"data-bs-princ_ativo="'.$user->princ_ativo.'" data-bs-quantidade="'.$user->quantidade.'" data-bs-valor="'.$user->valor.'">
                            ...
                            echo '
                                <a href="#" data-bs-toggle="modal" data-bs-target="#editar_modal" data-bs-nome="'.$user->nome.'" data-bs-princ_ativo="'.$user->princ_ativo.'"data-bs-papel="'.$user->quantidade.'" data-bs-valor="'.$user->valor.'" data-bs-id_med="'.$user->id_med.'">
                                    <button type="button" class="btn btn-primary">
                            ...
                            echo '
                                <a href="'.base_url('medicamentos/apagarusuario/'.$user->id_med).'">
                                    <button type="button" class="btn btn-primary">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <form method="post" id="cadastro_form" action="#" autocomplete="off">
            ...
            <div class="mb-3">
                <label for="princ_ativo" class="form-label">Princípio Ativo</label>
                <input type="text" class="form-control" id="princ_ativo" value="&nbsp">
            </div>
            <div class="mb-3">
...
function salvarCadastro(){
    ...
    var princ_ativo = document.getElementById('princ_ativo').value;
    ...
    */
    $.post("<?php echo base_url("medicamentos/novousuario") ?>",               //url 
        {nome:nome, princ_ativo:princ_ativo, quantidade:quantidade, valor:valor}, //dados que serão enviados
...
<div class="modal fade" id="visualizar_modal" data-bs-backdrop="static" data-bs-keyboard="false" 
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="staticBackdropLabel">Visualizar Medicamento</h5>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div class="modal-body">
        ...
        <form method="post" id="visualizar_form" action="#" autocomplete="off">
            ...
            <div class="mb-3">
                <label for="v_princ_ativo" class="form-label">Princípio Ativo</label>
                <input type="text" class="form-control" id="v_princ_ativo" value="&nbsp" disabled>
            </div>
            <div class="mb-3">
...
$('#visualizar_modal').on('show.bs.modal', function(e) {
    ...
    var princ_ativo = $(e.relatedTarget).data('bs-princ_ativo');
    ...
    document.getElementById('v_princ_ativo').value = princ_ativo;
...
<div class="modal fade" id="editar_modal" data-bs-backdrop="static" data-bs-keyboard="false" 
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="staticBackdropLabel">Editar cadastro de Medicamento</h5>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div class="modal-body">
        ...
        <form method="post" id="e_modal" action="#" autocomplete="off">
            ...
            <input type="text" style="display:none" id="e_id_med">
            <div class="mb-3">
                <label for="e_nome" class="form-label">Nome</label>
                <input type="text" class="form-control" id="e_nome" value="&nbsp">
            </div>
            <div class="mb-3">
                <label for="e_princ_ativo" class="form-label">Princípio Ativo</label>
                <input type="text" class="form-control" id="e_princ_ativo" value="&nbsp">
            </div>
            <div class="mb-3">
...
$('#editar_modal').on('show.bs.modal', function(e) {
    ...
    document.getElementById('e_princ_ativo').value = princ_ativo;
...
function editarCadastro(){
    ...
    var princ_ativo = document.getElementById('e_princ_ativo').value;
    var quantidade = document.getElementById('e_quantidade').value;
    var valor = document.getElementById('e_valor').value;

    $.post("<?php echo base_url("medicamentos/editarusuario") ?>",               
        {id_med:id_med, nome:nome, princ_ativo:princ_ativo, quantidade:quantidade, valor:valor}, 
        function(data) {                                                   
            if (data == 'true') {
                Swal.fire({
                    title: 'Sucesso!',
